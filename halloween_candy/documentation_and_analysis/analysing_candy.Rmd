  ...
  mutate(is_bar = if_else(
    str_detect(
      ...
      c("hersheys_dark_chocolate", "coffee_crisp", "twix", "three_musketeers",
        ...
        "hershey_s_milk_chocolate", "kit_kat", "mars"), 
    TRUE, FALSE)
    ) %>% 
  filter(is_bar == TRUE) 
```
...
```
### Answer:
The most popular candy bar by this rating system is for:
- Male:                 kit_kat     - 1439 votes
- Female:               kit_kat     - 766 votes
- Other:                twix        - 32 votes
